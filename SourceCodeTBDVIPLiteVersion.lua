...
SafeConnect(RunService.Heartbeat, LPH_NO_VIRTUALIZE(function(dt)
    ...
    -- COMBINED FACING ENGINE (CAMLOCK & AUTO HOLD BOMB)
    ...
    -- AUTOMATIC WALLHOP EXECUTION ENGINE
...
-- WALLHOP & MULTI-JUMP CONNECTOR (PREMIUM LITE IMPLEMENTATION)
...
-- [[ MAIN MENU STRUCTURE ]]
-- ========================================================
local Window = Library:CreateWindow("LOUIS TBD LITE EDITION", "discord.gg/P2FEVBz2PG")
...
Library:Notify("LOUIS HUB LITE EDITION INSTANTIATED", "Press UI Menu Key to hide/show Main UI.", 4)

-- --- TAB 1: WELCOME (LUCIDE ICON: "home") ---
local TabMain = Window:CreateTab("Welcome", "home")
TabMain:CreateParagraph("Welcome!", "Hello " .. LocalPlayer.Name .. "!\nThank you for executing Louis TBD Lite Edition.")
...
TabCombat:CreateParagraph("Flick & Hold Controls", "Manipulate camera behaviors when holding the bomb or approaching opponents.")
...
TabCombat:CreateParagraph("Range Hitbox Expander", "Locally teleports you to opponents when they touch your customized hitbox radius to pass the bomb.")
...
TabCombat:CreateParagraph("Trip, Freeze & Infinite Jump Settings", "Adjust advanced platform and jumping behaviors.")
...
TabVisuals:CreateParagraph("Camera Settings", "Manipulate rendering field of view.")
