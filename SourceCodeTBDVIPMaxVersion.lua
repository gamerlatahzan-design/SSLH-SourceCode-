...
-- WALLHOP DETEKSI DETIL (BOUNDING BOX)
...
local function performWallhop(visualStyle)
    ...
    -- Deteksi dengan Stud (Raycast) - Hanya jika studEnabled bernilai true
    ...
    -- Deteksi Alternatif: Bounding Box
